...
To use these stylesheets, rename the files and baileys with the name of your theme.
...
baileys-alpha-default-narrow.css  
...
baileys-alpha-default-normal.css
...
baileys-alpha-default-wide.css
